...
export default function Navbar() {
  ...
  return (
    <nav className="sticky bottom-0 flex h-full max-h-[50px] w-full justify-evenly border-t border-slate-200 bg-white p-2 dark:border-slate-700 dark:bg-slate-900 min-[520px]:top-0 min-[520px]:bottom-auto min-[520px]:left-0 min-[520px]:max-h-full min-[520px]:max-w-min min-[520px]:flex-col min-[520px]:justify-start min-[520px]:gap-6 min-[520px]:border-t-0">
      <Link
        href="/home"
